...
/* ==================== القائمة الجانبية الشيك (Glassmorphism) ==================== */
.side-drawer {
...
.package-card {
    background: linear-gradient(145deg, var(--bg-card), var(--input-bg));
    border-radius: 24px;
    padding: 30px;
    border: 1px solid var(--input-border);
...
@media (max-width: 768px) {
    .animated-logo-container { width: 250px; height: 250px; }
    .footer-card { padding: 30px 20px; }
    .footer-contact-info { flex-direction: column; width: 100%; }
